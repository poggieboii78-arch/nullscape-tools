...
export default function Home(){
 ...
 return <main className="shop-page">
  <header className="topbar"><a href="https://nullscape-tools.poggieboii78.chatgpt.site" className="tools-back">← Tools</a><a className="brand" href="https://nullscape-tools.poggieboii78.chatgpt.site" aria-label="Back to Nullscape Tools"><span className="brand-mark"><img src={icon("Business License")} alt=""/></span><span>SHOP CALCULATOR</span></a><span className="header-run-summary">LVL {run.level} · {run.players}P · {run.difficulty.toUpperCase()}</span></header>
