...
export default function LobbyStyler(){
  ...
  return <section className={styles.editor}>
    ...
    <div className={`${styles.output} lobby-styler-output`}><div><span>ROBLOX RICHTEXT</span><small>Copy this exact string into the lobby name field</small></div><code>{markup}</code><button type="button" onClick={copy}>{copied?"COPIED ✓":"COPY MARKUP"}</button></div>
  </section>;
}
