...
export default function ProgressionPage(){
  ...
  const toolSteps=useMemo(()=>[
    {selector:".progression-predictor",title:"Read the fixed timeline",text:"The next active breakpoint is calculated from your current level, difficulty, and selected enemies."},
    {selector:"[data-tour='dock-handle']",title:"Keep the run current",text:"Open the Quick Menu to update the level, difficulty, lobby, and enemies. The countdown changes immediately."},
  ],[]);
  return <main className="progression-tool-page">
    ...
    <div className="shell progression-shell">
      <section className="intro progression-intro">
        ...
        <p className="lede">Progression events happen at fixed level breakpoints. Set your run and see the next active event plus the full timeline.</p>
      </section>
      <ProgressionEventPredictor run={run}/>
    </div>
    <footer><span>NULLSCAPE TOOLS</span><span>Fixed schedule reference · Unofficial fan project.</span></footer>
