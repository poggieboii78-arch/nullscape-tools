...
export default function Home(){
  ...
  const steps=useMemo(()=>[
    ...
    {selector:"[data-tour='tool-cards'] .tool-card:last-child",title:"Come back any time",text:"Both calculators return here without clearing the run. Use Walkthrough in the drawer whenever you want this guide again."},
  ],[]);
  return <main>
    ...
    <div className="shell" id="top">
      ...
      <section className="tools" aria-labelledby="tools-heading" data-tour="tool-cards">
        <div className="section-heading"><div><p className="eyebrow">AVAILABLE NOW</p><h2 id="tools-heading">Pick a tool</h2></div><span>3 TOOLS</span></div>
